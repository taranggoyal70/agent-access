...
- The chosen model **must** support tool calling. One that does not will answer without invoking anything and the run will complete having proved nothing. This is not currently detected up front.
